...
return (
    <>
        <input type="checkbox" checked={javaChecked} onChange={handleJavaChecked}/>{" "} JAVA
        <input type="checkbox" checked={phpChecked} onChange={handlePhpChecked}/>{" "} PHP
        <input type="checkbox" checked={csChecked} onChange={handleCsChecked}/>{" "} C#


        <div>Java : {javaChecked.toString()}</div>
        <div>PHP : {phpChecked.toString()}</div>
        <div>C# : {csChecked.toString()}</div>
